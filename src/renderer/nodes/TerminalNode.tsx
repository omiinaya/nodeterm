...
export function TerminalNode({
  ...
  return (
    ...
    >
      <MatchSizeNodeResizer nodeId={id} minWidth={NODE_MIN_SIZES.terminal.width} minHeight={NODE_MIN_SIZES.terminal.height} isVisible={selected && !collapsed} color="#0a84ff" />
